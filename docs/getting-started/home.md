...
<img src="../images/home/1.png" alt="Carousel Image 1" style="border-radius: 8px;">
</div>

<!-- Item 2 (Center) -->
<div class="carousel-card card-center" onclick="/* Center click */">
<img src="../images/home/2.png" alt="Carousel Image 2" style=" border-radius: 8px;">
</div>

<!-- Item 3 (Right) -->
<div class="carousel-card card-right" onclick="rotateCarousel('right')">
<img src="../images/home/3.png" alt="Carousel Image 3" style=" border-radius: 8px;">
</div>

<!-- Item 4 (Hidden) -->
<div class="carousel-card" onclick="/* hidden */">
<img src="../images/home/4.png" alt="Carousel Image 4" style=" border-radius: 8px;">
</div>

<!-- Item 5 (Hidden) -->
<div class="carousel-card" onclick="/* hidden */">
<img src="../images/home/5.png" alt="Carousel Image 5" style=" border-radius: 8px;">
</div>
...
<img src="../images/home/code.svg" alt="Secure Code" width="14" height="14" style="vertical-align:text-bottom; margin-right:6px;" /> Secure Code
</button>
<button class="tab-btn" onclick="selectCategory('cloud', this)">
<img src="../images/home/cloud.svg" alt="Secure Cloud" width="14" height="14" style="vertical-align:text-bottom; margin-right:6px;" /> Secure Cloud
</button>
<button class="tab-btn" onclick="selectCategory('workloads', this)">
<img src="../images/home/workloads.svg" alt="Secure Workloads" width="14" height="14" style="vertical-align:text-bottom; margin-right:6px;" /> Secure Workloads
</button>
<button class="tab-btn" onclick="selectCategory('ai', this)">
<span class="tab-badge badge-new">NEW</span>
<img src="../images/home/ai.svg" alt="Secure AI" width="14" height="14" style="vertical-align:text-bottom; margin-right:6px;" /> Secure AI
</button>
<button class="tab-btn" onclick="selectCategory('onprem', this)">
<span class="tab-badge badge-star">★★★</span>
<img src="../images/home/onprem.svg" alt="Secure On-Premise" width="14" height="14" style="vertical-align:text-bottom; margin-right:6px;" /> Secure On-Premise
</button>
<button class="tab-btn" onclick="selectCategory('compliance', this)">
<span class="tab-badge badge-standards">45+</span>
<img src="../images/home/compliance.svg" alt="Compliance" width="14" height="14" style="vertical-align:text-bottom; margin-right:6px;" /> Compliance
</button>
</div>
...
<img src="../images/home/shield.svg" alt="DevSecOps" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> DevSecOps (ASPM)
</div>
<div class="module-item" data-cat="code" onclick="selectModule('api', this)">
<img src="../images/home/api.svg" alt="API Security" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> API Security
</div>

<!-- CLOUD -->
<div class="module-item" data-cat="cloud" style="display:none;" onclick="selectModule('cspm', this)">
<img src="../images/home/cloud.svg" alt="Cloud Security" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Cloud Security (CSPM)
</div>
<div class="module-item" data-cat="cloud" style="display:none;" onclick="selectModule('cdr', this)">
<img src="../images/home/cdr.svg" alt="Cloud Detection & Response" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Cloud Detection &amp; Response (CDR)
</div>
<div class="module-item" data-cat="cloud" style="display:none;" onclick="selectModule('secrets', this)">
<img src="../images/home/key.svg" alt="Secrets Manager" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Secrets Manager
</div>

<!-- WORKLOADS -->
<div class="module-item" data-cat="workloads" style="display:none;" onclick="selectModule('cwpp', this)">
<img src="../images/home/shield.svg" alt="Runtime Protection" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Runtime Protection (CWPP)
</div>
<div class="module-item" data-cat="workloads" style="display:none;" onclick="selectModule('vmsec', this)">
<img src="../images/home/host.svg" alt="VM Security" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> VM Security
</div>
<div class="module-item" data-cat="workloads" style="display:none;" onclick="selectModule('kspm', this)">
<img src="../images/home/wheel.svg" alt="Kubernetes Security Posture" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Kubernetes Security Posture (KSPM)
</div>

<!-- AI -->
<div class="module-item" data-cat="ai" style="display:none;" onclick="selectModule('prompt-firewall', this)">
<img src="../images/home/ai.svg" alt="Prompt Firewall" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Prompt Firewall
</div>
<div class="module-item" data-cat="ai" style="display:none;" onclick="selectModule('red-teaming', this)">
<img src="../images/home/ai.svg" alt="Red Teaming" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Red Teaming
</div>
<div class="module-item" data-cat="ai" style="display:none;" onclick="selectModule('ai-dr', this)">
<img src="../images/home/ai.svg" alt="AI-DR" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> AI-DR
</div>
<div class="module-item" data-cat="ai" style="display:none;" onclick="selectModule('model-armor', this)">
<img src="../images/home/ai.svg" alt="ModelArmor" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> ModelArmor
</div>

<!-- COMPLIANCE -->
<div class="module-item" data-cat="compliance" style="display:none;" onclick="selectModule('comp', this)">
<img src="../images/home/compliance.svg" alt="Continuous Compliance" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> Continuous Compliance
</div>

<!-- ONPREM -->
<div class="module-item" data-cat="onprem" style="display:none;" onclick="selectModule('onprem-install', this)">
<img src="../images/home/onprem.svg" alt="On-Prem Deployment" width="18" height="18" style="vertical-align:middle; margin-right:6px;" /> On-Prem Deployment
</div>
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/api-security.png"  alt="API Security" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/cspm.png"  alt="Cloud Security (CSPM)" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/CDR.png"  alt="Cloud Detection & Response (CDR)" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/secrets-manger.png"  alt="Secrets Manager" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/cwpp.png"  alt="Runtime Protection (CWPP)" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/kspm.png"  alt="KSPM" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/aiml-sec.png"  alt="Prompt Firewall" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/aiml-sec.png"  alt="Red Teaming" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/aiml-sec.png"  alt="AI-DR" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/aiml-sec.png"  alt="ModelArmor" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/compliance.png"  alt="Continuous Compliance" />
</div>
...
<div class="module-visual-placeholder">
<img src="../images/home/onprem.png"  alt="On-Prem Deployment" />
</div>
...
<img src="../images/home/shield.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/cdr.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/compliance.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/cloud.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/container.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/ai.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/wheel.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/eye.svg" width="24" height="24" alt="" />
</div>
...
<div class="use-case-header">
<div class="use-case-icon icon-blue">
<img src="../images/home/grid.svg" width="24" height="24" alt="" />
</div>
...
<img src="../images/home/integrations-updated.png" alt="Integrations" class="integrations-image">
</div>
...
<img src="../images/home/badge1.svg" alt="Tech Support Icon">
...
<div class="section5-card">
<img src="../images/home/badge2.svg" alt="Certification Icon">
...
<div class="section5-card">
<img src="../images/home/badge3.svg" alt="Downloads Icon">
